...
bool pallet_seg_msg__msg__pallet_mask__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pallet_seg_msg.msg._pallet_mask.PalletMask", full_classname_dest, 42) == 0);
  }
  pallet_seg_msg__msg__PalletMask * ros_message = _ros_message;
  {  // masks
...
{
  /* NOTE(esteve): Call constructor of PalletMask */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("pallet_seg_msg.msg._pallet_mask");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PalletMask");
